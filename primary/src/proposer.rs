...
use crate::messages::{Certificate, Decision, Header};
...
pub struct Proposer {
    ...
    /// Receives info on next view decision 
    rx_next_view_decision: Receiver<Decision>,
...
impl Proposer {
    ...
    pub fn spawn(
        ...
        tokio::spawn(async move {
            Self {
                ...
                tx_core,
                round: 0,
                next_view_decision: Decision::Empty,
    ...
    pub async fn run(&mut self) {
        ...
        debug!("max delay is {}", self.max_header_delay);
        tokio::pin!(timer);
        ...
        loop {
            ...
            tokio::select! {
                ...
                Some(decision) = self.rx_next_view_decision.recv() => {
                    self.next_view_decision = decision;
                }
            }
        }
    }
